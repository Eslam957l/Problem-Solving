...
Users can add multiple clients in a single session, and each record is appended to the file.
Useful for practicing structs, file handling, and user input in C++.
